...
AgentSDK的工具系统为Agent提供了与外部世界交互的能力。从文件操作到网络请求，工具让Agent能够执行实际任务。
...
- [内置工具源码](https://github.com/wordflowlab/agentsdk/tree/main/pkg/tools/builtin)
- [工具示例](https://github.com/wordflowlab/agentsdk/tree/main/examples/tools)
