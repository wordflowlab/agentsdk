...
// NewSkillCallTool 创建 SkillCallTool 实例
func NewSkillCallTool(config map[string]interface{}) (tools.Tool, error) {
	return &SkillCallTool{}, nil
}
...
func (t *SkillCallTool) InputSchema() map[string]interface{} {
...
func (t *SkillCallTool) Execute(ctx context.Context, input map[string]interface{}, tc *tools.ToolContext) (interface{}, error) {
	// 获取 Runtime
...
func (t *SkillCallTool) Prompt() string {
